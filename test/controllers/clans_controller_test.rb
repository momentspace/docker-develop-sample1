...
class ClansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clan" do
    assert_difference('Clan.count') do
      post clans_url, params: { clan: { leader_id: @clan.leader_id, name: @clan.name, server_id: @clan.server_id } }, as: :json
    end
  ...
  test "should update clan" do
    patch clan_url(@clan), params: { clan: { leader_id: @clan.leader_id, name: @clan.name, server_id: @clan.server_id } }, as: :json
    assert_response 200
  end
